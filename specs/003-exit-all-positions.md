# Implementation Spec: DELETE /positions - Exit All Positions
...
**Response Model**
Create a simple POJO named `PositionsExitResponse` with the following fields (use Lombok annotations, getters, setters, and no-arg constructor, matching the style of other response models in the project):
