...
public enum DataAPIError {
  ...
  TOO_MANY_CONNECTIONS(
      805,
      "Too many requests or connections. Further requests may result in the user being blocked",
      429),
  ...
  public static DhanAPIException makeException(ByteBuffer buffer) {
    ...
    return new DhanAPIException(
        String.valueOf(error.code), "Unknown Error Code received from Dhan API Server!");
  }
