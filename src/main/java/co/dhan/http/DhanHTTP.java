...
public class DhanHTTP {
  ...
  public DhanResponse doHttpGetRequest(@NotNull String endpoint) throws DhanAPIException {
    return doHttpGetRequest(endpoint, null);
  }

  public DhanResponse doHttpGetRequest(
      @NotNull String endpoint, Map<String, String> requestParameters) throws DhanAPIException {
  ...
  public DhanResponse doHttpDeleteRequest(String endpoint) throws DhanAPIException {
