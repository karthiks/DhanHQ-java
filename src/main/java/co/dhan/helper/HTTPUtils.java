...
public class HTTPUtils {
  ...
  static {
    ...
    module.addDeserializer(
        ExchangeSegmentCandlesticksWrapper.class, new ExchangeSegmentCandlesticksDeserializer());
    module.addDeserializer(
        ExchangeSegmentQuotesWrapper.class, new ExchangeSegmentQuotesDeserializer());
  ...
  @NotNull
  public static String endpointWithURLParameters(
      @NotNull String endpoint, Map<String, String> requestParameters) {
