...
public class MarketQuotesEndpoint {
  ...
  public ExchangeSegmentCandlesticksWrapper getLTPFor(
      ExchangeSegmentSecurities exchangeSegmentSecurities) throws DhanAPIException {
  ...
  public ExchangeSegmentCandlesticksWrapper getOHLCFor(
      ExchangeSegmentSecurities exchangeSegmentSecurities) throws DhanAPIException {
    Map<String, String> payload = exchangeSegmentSecurities.toMapOfStrings();
    return dhanConnection
        .getDhanHTTP()
  ...
  public ExchangeSegmentQuotesWrapper getQuoteFor(
      ExchangeSegmentSecurities exchangeSegmentSecurities) throws DhanAPIException {
    Map<String, String> payload = exchangeSegmentSecurities.toMapOfStrings();
    return dhanConnection
        .getDhanHTTP()
