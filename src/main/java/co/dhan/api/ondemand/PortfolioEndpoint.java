...
public class PortfolioEndpoint {
  ...
  /**
   * @param currentPosition values that are considered are securityID, exchangeSegment,
  ...
  public void convertPosition(
      Position currentPosition, ProductType toProductType, int quantityToConvert)
      throws DhanAPIException {
