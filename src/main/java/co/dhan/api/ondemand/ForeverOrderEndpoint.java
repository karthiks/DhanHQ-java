...
public class ForeverOrderEndpoint {
  ...
  public ForeverOrderResponse placeForeverOrder(NewForeverOrderRequest foRequest)
  ...
  public ForeverOrderResponse modifyForeverOrder(ModifyForeverOrderRequest mfoRequest)
      throws DhanAPIException {
    Map<String, String> payload = new HashMap<>();
